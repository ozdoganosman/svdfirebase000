            ...
            <div className="relative">
              ...
              {(orderNumber || orderInfo?.orderNumber) && (
                <div className="mt-6 inline-block rounded-xl border-2 border-amber-200 bg-gradient-to-br from-amber-50 to-white px-6 py-4 shadow-sm">
                  <p className="text-xs font-semibold uppercase tracking-wide text-amber-600">Sipariş Numarası</p>
              ...
              <p className="mt-6 text-base text-slate-600 max-w-md mx-auto">
                Kredi kartı ödemeniz işleniyor. Lütfen bu sayfadan ayrılmayın.
                Ödeme onaylandığında otomatik olarak yönlendirileceksiniz.
              </p>
              ...
              <div className="mt-8 rounded-xl bg-slate-50 border border-slate-100 p-4">
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-sm text-slate-600 text-left">
                    Bu işlem birkaç dakika sürebilir. Eğer uzun süre beklerseniz,
                    siparişleriniz sayfasından durumu kontrol edebilirsiniz.
                  </p>
                </div>
              </div>
        ...
        <div className="rounded-2xl border border-green-200 bg-white p-6 sm:p-10 text-center shadow-xl overflow-hidden relative">
          ...
          <div className="relative">
            ...
            <span className="inline-flex items-center gap-2 rounded-full bg-green-100 px-4 py-2 text-sm font-semibold text-green-700">
              ...
              {orderInfo?.paymentMethod === "credit_card" ? "Ödeme Alındı" : "Sipariş Talebi Gönderildi"}
            </span>
            ...
            {(orderNumber || orderInfo?.orderNumber) && (
              <div className="mt-6 inline-block rounded-xl border-2 border-green-200 bg-gradient-to-br from-green-50 to-white px-6 py-4 shadow-sm">
                <p className="text-xs font-semibold uppercase tracking-wide text-green-600">Sipariş Numarası</p>
            ...
            <p className="mt-6 text-base text-slate-600 max-w-md mx-auto">
              {orderInfo?.paymentMethod === "credit_card"
                ? `Siparişiniz onaylandı ve hazırlanmaya başlandı. Kargoya verildiğinde size bilgi vereceğiz.`
            ...
            {orderInfo?.paymentMethod === "credit_card" && (
              <div className="mt-6 rounded-xl bg-green-50 border border-green-100 p-4">
                <div className="flex items-center justify-center gap-2 text-green-700">
                  ...
                  <span className="font-semibold">Ödeme Durumu: Başarılı</span>
                </div>
              </div>
            )}
              ...
              <>
                ...
                <div className="mt-6 rounded-xl bg-amber-50 border border-amber-200 p-5 text-left">
                  ...
                  <p className="text-xs text-amber-700 mt-3">
                    Açıklama kısmına sipariş numaranızı (<strong>{orderNumber || orderInfo?.orderNumber}</strong>) yazınız.
                  </p>
                </div>
                ...
                <div className="mt-4 rounded-xl bg-blue-50 border border-blue-200 p-5">
                  <div className="flex items-start gap-3 text-left">
                    ...
                    <div className="flex-1">
                      <p className="font-semibold text-blue-800">Dekont Yükleyin</p>
                      <p className="text-sm text-blue-700 mt-1">
                        Ödemenizi yaptıktan sonra dekontunuzu buraya yükleyin. Siparişiniz daha hızlı onaylanacaktır.
                      </p>
